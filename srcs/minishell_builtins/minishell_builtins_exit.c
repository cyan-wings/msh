...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/06 13:44:51 by myeow             #+#    #+#             */
/*   Updated: 2024/07/06 14:56:31 by myeow            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	minishell_builtins_exit_helper(char *exit_arg_str)
{
	long	exit_arg_value;
	char	*temp;
 ...
 */
int	minishell_builtins_exit(int argc, char **argv, int subshell_flag)
{
	...
	if (argc > 2)
	{
		...
		minishell_builtins_exit_helper(argv[1]);
	exit(exit_status);
}
